...
export default function ShareButtons({
  title = "Muñeco Tecnology — Soluciones Digitales y Apps",
  url,
  description = "Descubre aplicaciones, proyectos y artículos tecnológicos en Muñeco Tecnology.",
  label = "Compartir:",
  compact = false,
}: ShareButtonsProps) {
  ...
  return (
    <div className={`${styles.shareContainer} ${compact ? styles.compact : ""}`}>
      {label && <span className={styles.shareLabel}>{label}</span>}
